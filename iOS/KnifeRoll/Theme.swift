...
/// Unique palette for Knife Roll — evokes the collector & inventory utilities domain of knifes.
enum Theme {
    static let accent = Color(hex: "#8C6A56")
    static let background = Color(hex: "#141210")
    static let cardBackground = Color(hex: "#141210").opacity(0.6)
